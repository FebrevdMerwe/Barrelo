...
/// <summary>Thrown by an <see cref="IGameFactory"/> when the game it describes cannot be created — a
/// failure of the environment rather than of the request. Unlike <see cref="GameRuleViolationException"/> (thrown
