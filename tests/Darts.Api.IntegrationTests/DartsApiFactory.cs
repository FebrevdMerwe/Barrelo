...
/// production darts.db) and an explicit Plugins:Directory pointing at this test project's own copied
...
/// </summary>
public sealed class DartsApiFactory : WebApplicationFactory<Program>
{
    private readonly string _dbPath = Path.Combine(Path.GetTempPath(), $"darts-apitests-{Guid.NewGuid():N}.db");

    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.UseSetting("ConnectionStrings:DartsDb", $"Data Source={_dbPath}");
