/* Shared dartboard geometry + scoring helpers.
   Originally copied from Barrelo.Api/wwwroot/dartboard.js — this app deliberately has zero references to
   ...
   resolved segment/ring. The other two copies (mockup, Barrelo.Api) do not need this and stay unchanged. */
(function (global) {
  "use strict";
